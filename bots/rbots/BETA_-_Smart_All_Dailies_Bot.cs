...
{	
	...
	public string[] MultiOptions = {"A_Read_Me", "B_General_Options", "C_Toggle_entire_Catagories", "D_Toggle_specific_Classes", "E_Toggle_specific_Priority_Misc_Items", "F_Toggle_specific_Cosmetics", "G_Toggle_specific_Misc_Items"};
	public List<IOption> A_Read_Me = new List<IOption>() {
		new Option<string>("-", "Read Me 1", "This script is in BETA and is prone to bugs, report bugs found to Lord Exelot#9674.\nThe bot will automatically check if you own certain things and skips their farm if you have ->", ""),
		new Option<string>("-", "Read Me 2", "<- them already (unless disabled in the settings). It will also automatically skip any dailies you have no access to because you dont own I.E. a pet or arent a Legend.", ""),
		new Option<string>("-", "Read Me 3", "Thanks for helping out in this BETA test. The password is 'harbor'. Edit the script and fill it in at the top of the script", ""),
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		if (!Forms.Main.Text.StartsWith($"RBot 3.6.2.0")) {
