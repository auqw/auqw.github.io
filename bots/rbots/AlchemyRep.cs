...
public class AlchemyRep //Credit to; jz.#9644 ("not so cool, jayzee" on the server)
{
	//-----------EDIT BELOW-------------//
	public int MapNumber = 2142069;
	public readonly int[] SkillOrder = { 3, 1, 2, 4 };
		public int ScriptDelay = 1500;   //default = 700
	public int SaveStateLoops = 8700;
	public int TurnInAttempts = 10;
	public string[] AlchemyItems = { "Ice Vapor", "Dragon Scale", "Dragon Runestone" };
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			while (bot.Player.GetFactionRank("alchemy") < 10)
			{
