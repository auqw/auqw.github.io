...
public class BluuTemplate
{
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			{
				if (!bot.Quests.IsAvailable(939)) StopBot("Please Complete /battleunderc to run this bot.", "battleunderc");
				if (!bot.Quests.IsAvailable(2082)) StopBot("Please Unlock Essential Essences from Artix in /necropolis.", "necropolis");
			...
			StopBot("Successfully Farmed 10500 Spirit Orbs.", "necropolis");
		}
