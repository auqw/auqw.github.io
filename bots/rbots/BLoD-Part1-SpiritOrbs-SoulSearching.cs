...
public class Script
{
    ...
    public void ScriptMain(ScriptInterface bot)
    {
        ...
        while (!bot.ShouldExit())
        {
            ...
            {
                if (!bot.Quests.IsAvailable(939)) Console.WriteLine("Please Complete /battleunderc to run this bot.");
                if (!bot.Quests.IsAvailable(2082)) Console.WriteLine("Please Unlock Essential Essences from Artix in /necropolis.");
