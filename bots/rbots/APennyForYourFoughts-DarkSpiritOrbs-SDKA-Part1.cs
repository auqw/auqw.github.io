...
public class BluuTemplate
{
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			{
				if (!bot.Quests.IsAvailable(2089)) StopBot("Please Unlock A Penny For Your Foughts from Vayle in /necropolis.", "necropolis");
				InvItemFarm("DoomCoin", DoomCoinStack, "maul", "r2", "Left", 2089);
				SafeQuestComplete(2089);
            }
            StopBot("Successfully Farmed 10500 Dark Spirit Orbs.", "necropolis");
		}
