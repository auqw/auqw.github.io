...
public class FireAvatarsFavor
{
	...
	public string[] RequiredItems = {"Fire Avatar's Favor"};
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.Inventory.Contains("Fire Avatar's Favor", 300))
		{
			while (!bot.Player.Loaded) { }
			ItemFarm(
				"Onslaught Defeated", 6,
				Temporary: true,
				HuntFor: true,
				QuestID: 8244,
				MonsterName: "Shadefire Cavalry|Shadefire Colonel|Shadefire Major",
				MapName: "fireavatar"
			);
			ItemFarm(
				"Elemental Defeated", 6,
				Temporary: true,
				HuntFor: true,
				QuestID: 8244,
				MonsterName: "Living Shadowflame|Shadefire Elemental|Shadow Lava",
				MapName: "fireavatar"
			);
			SafeQuestComplete(8244);
		}
		StopBot("You now own 300x Fire Avatar's Favor");
	}
